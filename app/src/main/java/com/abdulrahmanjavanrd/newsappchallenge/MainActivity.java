...
//        NewsAdapter adapter = new NewsAdapter(this,news);
		// ListView ...
		ListView newsListView = findViewById(R.id.list_items);
	...
	private static List<News> extractFeatureFromJson(String newsJSON)
	{
		...
		try
		{
			...
			for (int i = 0; i < newsArray.length(); i++)
			{
				...
				summary = secondIndex.getString("bodyTextSummary");

//                	 News(String articleTitle, String articleImage, String articleSummary, String articleSection, String articleDate, String articlePublisher, String articleUrl)
				
				newsList.add(new News(title, image, summary, sectionName, date, authors, url));
			}
