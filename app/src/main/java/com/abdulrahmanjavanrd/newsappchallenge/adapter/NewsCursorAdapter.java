...
public class NewsCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        int _Iamge = cursor.getColumnIndex(NewsContract.NewsEntry.COLUMN_NEWS_IMAGE);
        int _Title = cursor.getColumnIndex(NewsContract.NewsEntry.COLUMN_NEWS_TITLE);
        int _Summary = cursor.getColumnIndex(NewsContract.NewsEntry.COLUMN_NEWS_DESC);
        int _Section = cursor.getColumnIndex(NewsContract.NewsEntry.COLUMN_NEWS_SECTION);
        int _Date = cursor.getColumnIndex(NewsContract.NewsEntry.COLUMN_NEWS_DATE);
        int _Publisher = cursor.getColumnIndex(NewsContract.NewsEntry.COLUMN_NEWS_AUTHOR);
        int _Uri = cursor.getColumnIndex(NewsContract.NewsEntry.COLUMN_NEWS_URL);
